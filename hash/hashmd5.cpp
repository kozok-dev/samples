...
BYTE HashMD5::getHashSize() {
	return 16;
}

BYTE HashMD5::getBlockSize() {
	return 64;
}
...
void HashMD5::Update(const BYTE *pdata, UINT len) {
	UINT i, j;
...
void HashMD5::getHash(BYTE *pdata) {
	CopyMemory(pdata, m_hash, 16);
}

void HashMD5::Calc(const UINT *pdata) {
